        ...
        {user?.fullName ? (
          <>
            <div
              ...
              className="border p-1 border-gray-300 text-zomato-400 w-10 h-10 rounded-full"
            >
              <img
...
function LargeNav({ SignIn, SignUp }) {
  ...
  return (
    <>
      <div className="hidden lg:inline container px-20 mt-3 mx-auto">
          ...
          {user?.fullName ? (
            <>
              <div className="relative w-20">
                <div
                  onClick={() => setIsDropdownOpen((prev) => !prev)}
                  className="border p-1 border-gray-300 text-zomato-400 w-10 h-10 cursor-pointer rounded-full"
                >
                  <img
                    src="https://image.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg"
                    alt=""
                ...
                {isDropdownOpen && (
                  <div className="absolute shadow-lg py-3  w-full bg-white z-20 flex flex-col gap-2">
                    <button>sign out</button>
                  </div>
                )}
              </div>
